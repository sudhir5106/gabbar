...
$getCategory=$db->ExecuteQuery("SELECT * FROM social_icon  WHERE Social_Id='".$_REQUEST['id']."'");
          ...
          <form class="form-horizontal form-label-left" action="" method="post" id="categoryform">
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="title" class="form-control col-md-7 col-xs-12" name="title" placeholder="title name" value="<?php echo $getCategory[1]['Name']?>"/>
              </div>
            </div>
             <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title"> Url Link <span class="required">*</span> </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="url" class="form-control col-md-7 col-xs-12" name="url" placeholder="http://www.facebook.com" value="<?php echo $getCategory[1]['Url']?>" />
              </div>
            </div>
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <span id="errmsg"></span>
                <input type="hidden" id="oldimage" value="<?php echo $getCategory[1]['Icon_Path']?>">
                <?php if($getCategory[1]['Icon_Path']!=''){ ?>
                <img src="<?php echo PATH_UPLOAD_IMAGE.'/social/'.$getCategory[1]['Icon_Path']?>" style="width:120px; margin-top:5px" />
                <?php } ?>
              </div>
            </div>
            <div class="item form-group">
