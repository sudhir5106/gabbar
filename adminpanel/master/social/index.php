          ...
          <form class="form-horizontal form-label-left" action="" method="post" id="categoryform">
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="title" class="form-control col-md-7 col-xs-12" name="title" placeholder="Social Media Name" />
              </div>
            </div>
            <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title"> Url Link <span class="required">*</span> </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="url" class="form-control col-md-7 col-xs-12" name="url" placeholder="http://www.facebook.com" />
              </div>
            </div>
            <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="imageupload">Icon Upload <span class="required">*</span> </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                (Note :  Icon Size Must Be 32*32)</div>
            </div>
            <div class="item form-group">
