...
$getCategory=$db->ExecuteQuery("SELECT * FROM gallery_image  WHERE Id='".$_REQUEST['id']."'");
          ...
          <form class="form-horizontal form-label-left" action="" method="post" id="categoryform">
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <img src="<?php echo PATH_UPLOAD_IMAGE.'/gallery/thumb/'.$getCategory[1]['Image']?>" style="width:120px; margin-top:5px" />
                <?php } ?>
              </div>
            </div>
            <div class="item form-group">
