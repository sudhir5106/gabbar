...
<form name="planresult" id="planresult">
		...
		while($val=mysql_fetch_array($rs)){
            ...
            <tr>
              ...
              <td><?php if(count($val['Image'])>0){ echo '<img src="'.LINK_ROOT.'/image_upload/slider/'.$val['Image'].'" style="width:100px">'; }else{ echo '<img src="'.LINK_ROOT.'/image_upload/thumb/defult.jpg"  style="width:50px">'; }?></td>
