        ...
        <form class="form-horizontal form-label-left" action="" method="post" id="categoryform">
          ...
          <div class="col-sm-12">
            <div class="item form-group">
               ...
               <label class="control-label col-sm-2 " for="email">Email id <span class="required">*</span> </label>
              <div class="col-sm-3 ">
                <input type="email" id="email_id" class="form-control col-md-7 col-xs-12" name="email_id" placeholder="info@myportal.com" value="<?php echo $getValue[1]['Email_Id'];?>">
              </div>
              <button id="submit" type="button" class="btn btn-success" name="submit">Update</button>
            </div>
          </div>
          <div class="clearfix"></div>
          </div>
