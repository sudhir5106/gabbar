...
//Get Here Faculities List
 $sql="SELECT Faculty_Id, First_Name, Middle_Name,Last_Name, DATE_FORMAT(DOB,'%d-%m-%Y') AS DOB, Father_Name, Qualification, Address,Mobile, Email, DATE_FORMAT(Join_Date,'%d-%m-%Y') AS Join_Date, Profile_Image, Country, State, City , Collage, Gender, Other_Contact FROM faculties FC LEFT JOIN countries CT ON CT.id=FC.Country LEFT JOIN states SS ON SS.id=FC.State LEFT JOIN cities CS ON CS.id=FC.City WHERE Faculty_Id='".$_REQUEST['id']."'";
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <form class="form-horizontal form-label-left" action="" method="post" id="addform">
          <input type="hidden" id="id" value="<?php echo $getEdit[1]['Faculty_Id']?>">
          <div class="col-sm-12">
            <div class="col-sm-6">
              ...
              <div class="item form-group">
                ...
                <?php if($getEdit[1]['Profile_Image']!=''){ ?>
                	<a href="<?php echo PATH_UPLOAD_IMAGE.'/profile/'.$getEdit[1]['Profile_Image']?>" target="_open"><img src="<?php echo PATH_UPLOAD_IMAGE.'/profile/thumb/'.$getEdit[1]['Profile_Image']?>" /></a>
