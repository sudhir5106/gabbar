...
$category=$db->ExecuteQuery("SELECT * FROM category ORDER BY Category_Name ASC");
?>
            ...
            <div class="col-sm-12"> 
              ...
              <div class="col-sm-6">
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-9">
                    <input type="text" id="page_url" class="form-control" name="page_url" placeholder="http://shrishtiarchitecure.com/project.php" />
                  </div>
                </div>
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-9">
                    <input type="text" id="page_heading" name="page_heading" required="required" class="form-control " placeholder="Page Heading">
                  </div>
                </div>
                <div class="item form-group">
                  <label class="control-label col-md-3 " for="meta_keyword"> Keyword <span class="required">*</span> </label>
                  <div class="col-md-9">
                    <textarea id="meta_keyword" name="meta_keyword" required="required" class="form-control" placeholder="Write Here Meta Keyword..." rows="5"></textarea>
                  </div>
                </div>
                <div class="item form-group">
                  <label class="control-label col-md-3" for="meta_desc">Description <span class="required"></span> </label>
                  <div class="col-md-9">
                    <textarea id="meta_desc" name="meta_desc"  class="form-control col-md-7 col-xs-12 " placeholder="Write Here Meta Description... "  rows="10"></textarea>
                  </div>
                </div>
              </div>
              <!---Close Here English --> 
              ...
              <div class="col-sm-6">
                <div class="item form-group">
                 ...
                 <div class="item form-group">
                  ...
                  <div class="col-md-9">
                    <input type="text" id="h_page_title" class="form-control" name="h_page_title" placeholder="Page Title" />
                  </div>
                </div>
                <div class="item form-group">
                  <label class="control-label col-md-3" for="h_page_heading">हैडिंग  </label>
                  <div class="col-md-9">
                    <input type="text" id="h_page_heading" name="h_page_heading"  class="form-control " placeholder="Page Heading">
                  </div>
                </div>
                <div class="item form-group">
                  <label class="control-label col-md-3 " for="h_meta_keyword"> संकेत शब्द </label>
                  <div class="col-md-9">
                    <textarea id="h_meta_keyword" name="h_meta_keyword"  class="form-control" placeholder="Write Here Meta Keyword..." rows="5"></textarea>
                  </div>
                </div>
                <div class="item form-group">
                  <label class="control-label col-md-3" for="meta_desc">विवरण  </label>
                  <div class="col-md-9">
                    <textarea id="h_meta_desc" name="h_meta_desc"  class="form-control col-md-7 col-xs-12 " placeholder="Write Here Meta Description... "  rows="10"></textarea>
                  </div>
                </div>
              </div>
            </div>
