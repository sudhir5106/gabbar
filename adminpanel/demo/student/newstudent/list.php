  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_title">
        ...
        <div class="item form-group">
              ...
              <div class="col-md-3 col-sm-3 ">
                <input type="text" id="student_name" class="form-control col-md-7 col-xs-12" name="student_name" placeholder="Student First Name"/>
              </div>
      ...
      <div id="deletemsg" title="Message" style="display:none; text-align:left;">
          <p>You can not delete this student details , <br/>
