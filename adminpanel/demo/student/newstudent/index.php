        ...
        <form class="form-horizontal form-label-left" action="" method="post" id="addform">
          ...
          <div class="col-sm-12">
            <div class="col-sm-6">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-9 col-sm-6 col-xs-12">
                  <input type="text" id="mother" name="mother" required="required" class="form-control col-md-7 col-xs-12 " placeholder="Mother's Name">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-9 col-sm-6 col-xs-12">
                  <input type="text" id="roll_no" name="roll_no"  class="form-control col-md-7 col-xs-12" placeholder="RG1230012">
          ...
          <div class="col-sm-6">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-9 col-sm-6 col-xs-12">
                  <input type="text" id="guardian_name" name="guardian_name"  class="form-control col-md-7 col-xs-12 " placeholder="Guardain Name">
              ...
              <!--<div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="joindate">Reg. Date  </label>
                <div class="col-md-9 col-sm-6 col-xs-12">
