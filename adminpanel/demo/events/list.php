      ...
      <div class="x_title">
        ...
        <div class="item form-group">
              ...
              <div class="col-md-3 col-sm-3 ">
                <input type="text" id="title" class="form-control col-md-7 col-xs-12" name="title" placeholder="Event Title"/>
                </div>
                
              <div class="col-md-3 col-sm-3 ">
               <input type="text" id="start_date" name="start_date" required="required" class="form-control col-md-7 col-xs-12 datepicker" placeholder="Start Date">
                </div>
              <div class="col-md-3 col-sm-3 ">
               <input type="text" id="end_date" name="end_date" required="required" class="form-control col-md-7 col-xs-12 datepicker" placeholder="End Date">
                </div>
               <div class="col-md-3 col-sm-3 ">
