            ...
            <div class="col-sm-12"> 
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="title" name="title" required="required" class="form-control col-md-7 col-xs-12 " placeholder="Event Title Write Here...">
                  </div>
                </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="start_date" name="start_date" required="required" class="form-control col-md-7 col-xs-12 datepicker" placeholder="15-06-2016">
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="end_date" name="end_date" required="required" class="form-control col-md-7 col-xs-12 datepicker" placeholder="15-07-2016">
                </div>
              </div>
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12 " for="start_time"> Time <span class="required">*</span> </label>
                <div class="col-md-2 col-sm-6 col-xs-12">
                  <input type="text" id="start_time" name="start_time" required="required" class="form-control col-md-6 col-xs-10 timepicker" placeholder="13:00" value=""> 
                  (24 houres format)
                </div>
                <div class="col-md-1 col-sm-3 col-xs-12 text-center"> TO</div>
                <div class="col-md-2 col-sm-6 col-xs-12">
                <input type="text" id="end_time" name="end_time" required="required" class="form-control col-md-6 col-xs-12 timepicker" placeholder="14:00" value="">
                </div>
              </div>
            <div class="item form-group">
