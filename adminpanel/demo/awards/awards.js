	...
	*/
	...
	$('#submit').click(function(){
		...
		{	
			...
			formdata.append('type', "addAwards");
			...
			/*formdata.append('h_date', $("#h_published_date").val());
	...
	$('#update').click(function(){
		...
		{	
		    ...
		    $('#loading').show();			
			var formdata = new FormData();
			formdata.append('type', "editAwards");
...
$(document).on('click','#search',function()
{
		...
		$.ajax({
			...
			type: "POST",
			data: {type:"searchList",title:$('#title').val(),date:$('#date').val()},
			async:false,
			success: function(data){ 
			$('#add').html(data);
			//alert(data);
