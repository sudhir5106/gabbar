...
$getList=$db->ExecuteQuery("SELECT Project_Id,Project_Title,Project_HTitle, Project_Image, Project_Desc,Project_HDesc FROM upcoming_projects ORDER BY Project_Id Desc");
?>
