...
$getList=$db->ExecuteQuery("SELECT Project_Id,Project_Title, Project_Image, Project_Desc FROM ongoing_projects WHERE Project_Category=1 ORDER BY Project_Id Desc");
?>
