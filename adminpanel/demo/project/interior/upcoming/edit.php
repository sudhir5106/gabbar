...
$getCategory=$db->ExecuteQuery("SELECT Project_Id,Project_Title, Project_Image, Project_Desc, Project_HTitle, Project_HDesc FROM upcoming_projects  WHERE Project_Id='".$_REQUEST['id']."'");
?>
