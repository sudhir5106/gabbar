      ...
      <div class="x_title">
        ...
        <div class="item form-group">
              ...
              <div class="col-md-3 col-sm-3 ">
                <input type="text" id="heading" class="form-control col-md-7 col-xs-12" name="heading" placeholder="Heading"/>
                </div>
              <div class="col-md-3 col-sm-3 ">
                <input type="text" id="date" class="form-control col-md-7 col-xs-12 datepicker" name="date" placeholder="12-06-2016"/>
              </div>
               <div class="col-md-3 col-sm-3 ">
