...
//get here menu list
$getMenu=$db->ExecuteQuery("SELECT * FROM menu WHERE Status=1 AND Defualt_Menu IS NULL ORDER BY Position ASC");
          ...
          <form class="form-horizontal form-label-left" action="" method="post" id="categoryform">
            ...
            <div class="item form-group">
              ...
              <div class="col-md-5 col-sm-6 col-xs-12">
                ...
                <option value="<?php echo $val3['Menu_Id']?>"><?php echo $val3['Menu_Name'];?></option>
                <?php } ?>
                </select>
              </div>
            </div>
