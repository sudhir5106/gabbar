...
?>
    ...
    <!-- js  -->
    <script src="<?php echo PATH_JS_LIBRARIES?>/jquery-min.js" type="text/javascript">
    </script> 
    <script src="<?php echo PATH_JS_LIBRARIES?>/bootstrap.min.js" type="text/javascript">
	</script>
...
$(document).on('click',".pager a",function(event)
   ...
   <!-- Carousel Slider Area Start -->
    <div class="owl-carousel-slider">
        <div class="slider owl-carousel">
           
           <?php foreach($getSlider as $value){?>
            <div class="item">
                <a href="#"><img alt="" src="<?php echo PATH_UPLOAD_IMAGE.'/slider/'.$value['Image'];?>"></a>
                <div class="carousel-caption">
                    <h1><?php echo $value['Title']?></h1>
                    <h2><?php echo $value['Description'];?></h2>
                    <a class="btn btn-system btn-lg" href=
                    "#"><i class="fa fa-check"></i>Start Now</a>
                </div>
            </div>
            <?php } ?>
           
        </div>
    </div><!-- Carousel Slider Area End -->
